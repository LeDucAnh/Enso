...
open class ElongationCell: UITableViewCell, Expandable {
  ...
  // MARK: Public properties
   var topViewHeight : CGFloat = ElongationConfig.shared.topViewHeight
...
extension ElongationCell {
  ...
  func setupConstraintsIfNeeded() {
    ...
    topViewHeightConstraint?.constant = self.topViewHeight - (separatorHeight * 2)
    ...
    if appearance.isParallaxEnabled, let parallaxFactor = appearance.parallaxFactor {
      parallaxViewHeightConstraint?.constant = self.topViewHeight + parallaxFactor
    }
  }
...
extension ElongationCell {
  ...
  fileprivate func updateCellState() {
    ...
    if let separatorHeight = appearance.separatorHeight {
      topViewHeightConstraint.constant = isExpanded ? self.topViewHeight : self.topViewHeight - separatorHeight * 2
      topViewTopConstraint.constant = isExpanded ? 0 : separatorHeight
    }
    
    let frontViewHeight = self.self.topViewHeight
  ...
  func hideSeparator(_ value: Bool, animated: Bool) {
    if let separatorHeight = appearance.separatorHeight {
      topViewHeightConstraint.constant = value ? self.topViewHeight : self.topViewHeight - separatorHeight * 2
