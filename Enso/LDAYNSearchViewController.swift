...
class LDAYNSearchViewController: YNSearchViewController, YNSearchDelegate {
    ...
    var returnAction:((_ selectedString : String)->Void)!
    func registerForReturnAction(action:@escaping ( _ selectedString : String)->Void)
    {
